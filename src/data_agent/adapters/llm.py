"""LangChain-backed model adapter and environment-driven provider factory."""
...
def create_llm() -> LLMProtocol:
    """Create the configured LangChain chat model behind the Runtime protocol."""
...
__all__ = ["LLMProtocol", "LangChainLLM", "create_llm"]
